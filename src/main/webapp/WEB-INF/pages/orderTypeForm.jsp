...
<div class="modal-body">
  <form:form data-toggle="validator" role="form" data-target="#editOrderType" cssClass="form-horizontal" modelAttribute="orderType" method="post" action="saveOrderType">
