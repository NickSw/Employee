...
<div class="modal-body">
  <form:form id="movementArchiveRegisterForm" data-toggle="validator" role="form" data-target="#editMovementArchive" cssClass="form-horizontal" modelAttribute="movementArchive" method="post" action="saveMovementArchive">
    ...
    <div class="modal-footer">
      ...
      <input type="submit" id="saveMovementArchive" class="btn btn-primary" value="Сохранить"/>
    </div>
  </form:form>
</div>
</body>
