...
<div class="modal-body">
  <form:form data-toggle="validator" role="form" data-target="#editEmployeeArchive" cssClass="form-horizontal" modelAttribute="employeeArchive" method="post" action="saveEmployeeArchive">
