        ...
        <div class="codrops-top clearfix">
          <div id="st-trigger-effects">
            ...
            <div class="table-name">
              <h3>
                Архив приказов по сотрудникам
                <c:if test="${pageContext.request.userPrincipal.name != null}">
                  (Редактирование)
                </c:if>
              </h3>
            </div>
            <div class="btn-home"><a href="/getAllEmployees"><button class="btn-menu" data-toggle="tooltip" title="На главную таблицу сотрудников"><span class="fa fa-home"></span>&nbsp;База сотруников</button></a></div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="panel panel-primary filterable">
            <div class="panel-heading">
              <c:if test="${pageContext.request.userPrincipal.name != null}">
                <a class="btn btn-default btn-xs"  data-toggle="modal" data-target="#modalClear" ><span class="fa fa-file-archive-o"></span>Очистка и экспорт архива</a>
              </c:if>
